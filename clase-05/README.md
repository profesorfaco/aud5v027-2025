...
Cerremos el paréntesis para el asunto de color entre variables visuales según Bertin, para poder pasar a que cada una de ellas tiene diferentes propiedades y capacidades para representar determinados tipos de información:
